function basescenex(widget_id, url, skin, parameters)
{
    ...
    self.parameters = parameters;
        ...
        entity1 = self.parameters.entity1;
...
console.log(self);
    ...
    var monitored_entities = 
        [
            ...
            {"entity": parameters.entity1, "initial": self.OnStateAvailable, "update": self.OnStateUpdate},
